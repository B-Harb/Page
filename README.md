...
<ul style="font-family:Courier; color:White; font-size: 14px; border:3px; border-style:solid; border-color:White; padding: 1em;"> <b style="font-family:Courier; color:White; font-sie: 19px;> Directories </b>
